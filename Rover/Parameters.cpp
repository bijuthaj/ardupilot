...
const AP_Param::Info Rover::var_info[] = {
    ...
    // @Param: MODE1
    // @DisplayName: Mode1
    // @Values: 0:Manual,1:Acro,3:Steering,4:Hold,5:Loiter,6:Follow,7:Simple,8:Dock,9:Circle,10:Auto,11:RTL,12:SmartRTL,15:Guided,16:AutoTune
    // @User: Standard
...
const AP_Param::GroupInfo ParametersG2::var_info[] = {
    ...
    // @Param: AUTO_TUNE_TEST
    // @DisplayName: Auto tune rate maximum
    // @Description: Auto tune rate maximum
    // @Units: deg/s
    // @Range: 0 360
    // @Increment: 1
    // @User: Standard
    AP_GROUPINFO("AUTO_TUNE_TEST", 58, ParametersG2, auto_tune_rate, 180.0f),

    // @Group: CIRC
    // @Path: mode_autotune.cpp
    AP_SUBGROUPINFO(mode_autotune, "RTUN", 59, ParametersG2, ModeAutoTune),
